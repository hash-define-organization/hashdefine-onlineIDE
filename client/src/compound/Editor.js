...
export default function Editor(props) {
  ...
  const [code, setcode] = useState(`//Online Cpp compiler to run Cpp program online
  #include <iostream>
  using namespace std;
  ...
  return (
    ...
    >
      <MenuItem onClick={()=>{setAnchorEl(null);setlang('c');setcode(`// Online C compiler to run C program online
#include <stdio.h>
...
int main() {
    ...
    <MenuItem onClick={()=>{setAnchorEl(null);setlang('cpp');setcode(`//Online Cpp compiler to run Cpp program online
  #include <iostream>
  using namespace std;
  ...
  `)}}>C++</MenuItem>
    <MenuItem onClick={()=>{setAnchorEl(null);setlang('cpp');setcode(`//Online Cpp14 compiler to run Cpp14 program online
  #include <iostream>
  using namespace std;
...
<MenuItem onClick={()=>{setAnchorEl(null);setlang('python');setcode(`#code
print("Welcome To Hashdefine IDE !")`)}}>Python3</MenuItem>
  </Menu>
